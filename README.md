...
- **3-day development window**
- Submissions after deadline accepted but scored lower

### Technical Constraints

- ✅ **Allowed:** React (Vite), TypeScript, Tailwind CSS
- ❌ **Not Allowed:** Copying existing SaaS templates, drag-drop builders, Next.js features

### Deliverables

1. **Part A:** Pixel-perfect Figma landing page
2. **Part B:** Authentication system
3. **Part C:** Dashboard with API integration
...
- Accessible basics (semantic HTML, keyboard navigation, focus states)
